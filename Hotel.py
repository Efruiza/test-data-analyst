...
print('Dado que hay 195 países reconocidos por la ONU y tenemos que las personas vienen de 178 países, podemos decir que vienen de casi todo el mundo. \n')
...
print("Concluimos que los meses con mayores cancelaciones son Mayo 2017, Octubre 2016 y Abril 2017")
...
M = hotel_yes_d["total_n"].max()
m = hotel_yes_d["total_n"].min()
...
corr2015 = hotel_2015.corr ()
plt.figure(figsize=(8,8))
ax = sns.heatmap(corr2015, annot=True, linecolor='white',linewidths=.3, fmt='.2f', cbar=True, cmap=(sns.color_palette("Blues")))
    

corr2016 = hotel_2016.corr ()
plt.figure(figsize=(8,8))
ax = sns.heatmap(corr2015, annot=True, linecolor='white',linewidths=.3, fmt='.2f', cbar=True, cmap=(sns.color_palette("Reds")))
    

corr2017 = hotel_2017.corr ()
plt.figure(figsize=(8,8))
ax = sns.heatmap(corr2015, annot=True, linecolor='white',linewidths=.3, fmt='.2f', cbar=True, cmap=(sns.color_palette("Greens")))
